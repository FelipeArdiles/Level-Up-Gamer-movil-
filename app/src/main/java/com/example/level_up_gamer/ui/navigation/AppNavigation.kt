...
import com.example.level_up_gamer.ui.screens.StoresMapScreen
...
sealed class Screen(val route: String) {
    ...
    object StoresMap : Screen("stores_map_screen")
...
fun AppNavigation() {
    ...
    NavHost(
        ...
        // 2. Mapa de Tiendas (arriba en la navegación)
        composable(Screen.StoresMap.route) {
            StoresMapScreen(navController = navController)
        }
